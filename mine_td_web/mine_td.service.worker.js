...
/** @type {string} */
const CACHE_VERSION = '1770646881|15351765387';
/** @type {string} */
const CACHE_PREFIX = 'mineTD-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mine_td.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mine_td.html","mine_td.js","mine_td.offline.html","mine_td.icon.png","mine_td.apple-touch-icon.png","mine_td.audio.worklet.js","mine_td.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["mine_td.wasm","mine_td.pck"];
